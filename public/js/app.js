...
favoriteIcons.forEach((favoriteIcon) => {
    ...
    favoriteIcon.addEventListener('click', function() {
        console.log('clicked');
        const selectedIcon = `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const nonSelectedIcon = `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.5 30C1.5 14.2599 14.2599 1.5 30 1.5C45.7401 1.5 58.5 14.2599 58.5 30C58.5 45.7401 45.7401 58.5 30 58.5C14.2599 58.5 1.5 45.7401 1.5 30Z" fill="#FBF8F4" stroke="#191919" stroke-width="3"/>
