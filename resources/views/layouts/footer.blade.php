<footer class="mx-auto bg-black rounded-t-2xl py-10">
    <div class="max-w-7xl mx-auto py-10">
        <div class="flex justify-around items-center pb-10">
            ...
            <p class="text-lightGray max-w-[243px]">Lorem ipsum dolor sit amet consectetur. Non at at risus dolor
                accumsan vitae dignissim.</p>
            <form action="">
        ...
        <div class="max-w-7xl mx-auto pt-10 px-5">
            <div class="flex justify-around items-baseline pb-10">
                ...
                <div>
                    <h3 class="text-white text-2xl mb-7 font-heading">Приклучи се</h3>
                    <p class="text-lightGray max-w-[243px]">Lorem ipsum dolor sit amet consectetur. Non at at risus
                        dolor accumsan vitae dignissim. V dolor sit amet consectetur. Non at at risus dolor accumsan
                        vitae dignissim</p>
                </div>
                <div>
                    <h3 class="text-white text-2xl mb-7 font-heading">За Крик</h3>
                    <p class="text-lightGray max-w-[243px]">Lorem ipsum dolor sit amet consectetur. Non at at risus
                        dolor accumsan vitae dignissim.</p>
