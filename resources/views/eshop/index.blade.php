...
@section('content')
    ...
    <div class="overflow-hidden">
        <h1 class="block text-center text-3xl font-semibold font-heading tracking-wide pt-10 mb-10">E-shop KРИК на младите</h1>
    </div>
...
{{--PRODUCT CARDS--}}
    <div class="max-w-7xl mx-auto mt-10 mb-10">
        ...
        <div class="grid grid-cols-3 py-10 mb-10">

            <div class="max-w-sm bg-white rounded-2xl shadow-lg relative pb-3">
                <a href="#">
                    <img class="rounded-2xl" src="{{asset('images/1-4.jpg')}}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-1 text-3xl tracking-normal text-gray-900">Прстен</h5>
                    </a>
                    <p class="mb-1 font-light">Од алуминиумска жица</p>
                    <p class="mb-3 text-2xl font-semibold text-gray-700">300 МКД</p>
                </div>
        ...
        <div class="text-center"><x-black-btn class="px-[5rem]">Види повеќе продукти</x-black-btn></div>
    </div>
